...
class BlogActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val rvBlog = findViewById<RecyclerView>(R.id.rvBlogAll)
        rvBlog.layoutManager = LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false)

        // Menambahkan margin antar item blog
        val marginDecoration = MarginItemDecoration(20) // 10dp margin atas
        rvBlog.addItemDecoration(marginDecoration)

        val adapter = BlogAdapter(getBlogData(), isHomeLayout = false) { blogItem ->
    ...
    private fun getBlogData(): List<BlogItem> {
        ...
        return fullData // Kembalikan data blog
    }
}
